...
UPDATE DEPT_TEMP SET LOC = 'HELLO';
...
SELECT * FROM DEPT_TEMP WHERE DEPTNO = 40;
...
DELETE FROM EMP_TEMP2
WHERE EMPNO IN (SELECT E.EMPNO FROM EMP E JOIN SALGRADE S ON E.SAL BETWEEN S.LOSAL AND S.HISAL
